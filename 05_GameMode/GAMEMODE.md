# Game Mode
Typically GameMode is used to set the rules for the type of desired play. This is where we'll make it so that we can randomly spawn enemies on our map.
...
## Unreal Editor - A Blueprint for Our GameMode
...
## Unreal Editor - Save and Play

Save the project and try playing it.
